 ...
 * gallery.js
 * ------------------------------------------------------------------
 * One responsibility: the gallery.html page. Loads approved photos
 * via getGallery, renders the grid + lightbox, and handles the guest
 * upload modal (file -> base64 -> submitPhoto).
 * ------------------------------------------------------------------
 */
